    ...
    >
      <div className="coordina-footer-container">
          ...
          <div className="coordina-footer-newsletter">
            ...
            <div className="coordina-newsletter-form">
              <input 
                ...
                className="coordina-email-input" 
                aria-label="Email for newsletter"
              />
              <button className="coordina-subscribe-btn" aria-label="Subscribe to newsletter">SUBSCRIBE</button>
            </div>
          </div>
        ...
        <div className="coordina-footer-nav">
          <a href="#venues" className="coordina-nav-link" aria-label="Go to Venues section">
            Venues
          </a>
          <a href="#about" className="coordina-nav-link" aria-label="Go to About section">
            About
          </a>
          <a href="#contact" className="coordina-nav-link" aria-label="Go to Contact Us section">
            Contact Us
          </a>
          <a href="#reviews" className="coordina-nav-link" aria-label="Go to Reviews section">
            Reviews
          </a>
        </div>
