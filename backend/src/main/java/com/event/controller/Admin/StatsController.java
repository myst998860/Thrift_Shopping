...
// Double bookingRevenueValue = bookingRepo.findTotalBookingCost();
// long bookingRevenue = bookingRevenueValue != null ?
// bookingRevenueValue.longValue() : 0L;

// BigDecimal orderRevenueValue = orderRepo.findTotalOrderAmount();
// long orderRevenue = orderRevenueValue != null ? orderRevenueValue.longValue()
// : 0L;
...
// long partnerBookings = bookingRepo.countByVenue_Partner(partner);
// Double partnerRevenueValue = bookingRepo.findTotalCostByPartner(partner);
// long partnerRevenue = partnerRevenueValue != null ?
// partnerRevenueValue.longValue() : 0L;
...
// double growth = ((double) (currentCount - previousCount) / previousCount) *
// 100;
