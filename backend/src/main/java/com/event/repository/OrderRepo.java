...
public interface OrderRepo extends JpaRepository<Order, Long> {
	...
	@Query("SELECT COUNT(o) FROM Order o WHERE LOWER(o.status) NOT IN ('completed', 'cancelled', 'canceled')")
...
// */
// @Query("SELECT MONTH(o.createdAt) as month, COALESCE(SUM(o.totalAmount), 0)
// as revenue " +
// "FROM Order o " +
// "WHERE YEAR(o.createdAt) = YEAR(CURRENT_DATE) " +
// "GROUP BY MONTH(o.createdAt) " +
...
// */
// @Query("SELECT o.paymentMethod, COUNT(o) FROM Order o GROUP BY
// o.paymentMethod")
